...
DMS_layer_data <- read.csv(here("results/lassoCV/DMS/DMS_esmc_300_lassoCV_all_layers.csv"))
DMS_data_ordered <- c('YAP1 singles', 'BRCA1 RING', 'UBE4B MOUSE', 'BLAT ECOLX 2013', 'PABP singles', 'GAL4 YEAST', 'RL401 2013', 'RL401 2016', 'RL401 2014', 'IF1 ECOLI', 'BRCA1 BRCT', 'TIM SULSO', 'TIM THEMA', 'TIM THETH', 'DLG4 RAT', 'POLG HCVJF', 'MTH3 HAEAESTABILIZED', 'SUMO1 HUMAN', 'CALM1 HUMAN', 'PA FLU', 'UBC9 HUMAN', 'RASH HUMAN', 'TPK1 HUMAN', 'BG STRSQ', 'TPMT HUMAN', 'PTEN HUMAN', 'HSP82 YEAST', 'BLAT ECOLX 2015', 'KKA2 KLEPN', 'BLAT ECOLX 2012', 'BLAT ECOLX 2014', 'AMIE PSEAE', 'MK01 HUMAN', 'B3VI55 LIPST', 'B3VI55 LIPSTSTABLE', 'parEparD all', 'HG FLU', 'BF520 env', 'BG505 env', 'PABP doubles')


DMS_layer_data$Dataset <- factor(DMS_layer_data$Dataset, levels = DMS_data_ordered)



plot <- ggplot(DMS_layer_data) +
  geom_line(aes(x = Layer, y = R2_score_train, color = "Train")) + 
  geom_line(aes(x = Layer, y = R2_score_test, color = "Test")) +
  ...
  #labs(color = "Metric") +
  theme_minimal_grid(12, rel_small = 1)+  # Adjust base size as needed for figure size
  theme(
          legend.position = "top",
...
# 
# ggsave(plot,
#       filename = "DMS_Layers_all_datasets.png",
#        path = here('figs'),
#        width = 9,
#        height = 12,
#       dpi=600)
...
DMS_layer_data <- read.csv(here("DMS_esmc_best_layer.csv"))


DMS_best_layer <- ggplot(DMS_layer_data, 
       aes(x = factor(Layer), 
           y = Count)
       ) +
  ...
  theme_minimal() +
  labs(
    #title = "Best Layer Counts for DMS",
    x = "Layer",
    y = "Count"
  ) +
...
# ggsave(DMS_best_layer,
#       filename = "sup9_DMS_best_layer.png",
#        path = here('figs'),
#        width = 7,
#        height = 4,
#       dpi=600)
