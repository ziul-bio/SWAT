...
methods=('iDCT1' 'iDCT2' 'iDCT3' 'iDCT4' 'iDCT5' 'mean' 'bos' 'maxPool' 'pca1' 'pca2' 'pca1-2' 'rbf1' 'rbf2' 'sigmoid1' 'sigmoid2')
#methods=('iDCT1' 'iDCT2' 'iDCT3' 'iDCT4' 'iDCT5')
...
do
    ...
    do
        ...
        #time python scripts/compressing_embeddings.py -e "embeddings/embeddings_DMS/${dir}_esm2_150M/" -o "embeddings/embeddings_DMS_compressed/${dir}_esm2_150M_compressed/" -c $method -l 30
        #time python scripts/compressing_embeddings.py -e "embeddings/embeddings_pisces/pisces_esm2_150M/" -o "embeddings/embeddings_pisces/embeddings_pisces_compressed/" -c $method -l 30
        time python scripts/compressing_embeddings.py -e "embeddings/embeddings_uniprot_EC/uniprot_EC_esm2_150M/" -o "embeddings/embeddings_uniprot_EC/uniprot_EC_esm2_150M_compressed/" -c $method -l 30
    done
done
