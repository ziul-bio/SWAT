...
do
    ...
    # echo "HIS7"
    time python scripts/run_reg_LassoCV_sampling.py -i "embeddings/HIS7_compressed/${model}/embed_HIS7_mean.pt" -m "data/HIS7_metadata/HIS7_YEAST_Kondrashov2017_metadata.csv" -o "results/lassoCV_sampling/HIS7/HIS7_sampling_${model}_mean.csv"
done
