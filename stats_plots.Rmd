...
# Sup 3A: DMS 150M/650M/15B Boxplot # NOT UPDATED
...
```{r}
multi_mod_DMS <- read.csv(here("results/summary_lassoCV_multi_model_DMS_all.csv"))
...
# Sup 3B: Pisces 150M/650M/15B boxplot #NOT UPDATED
```{r}
...
```{r}
multi_mod_pisces <- read.csv(here("results/summary_lassoCV_multi_model_pisces_all.csv"))
...
```{r}
his7_sampling <- read.csv(here('results/summary_lassoCV_HIS7_datasize_effect.csv'))
...
# Supplementary Figure 4 #NOT UPDATED
```{r}
...
inc_order <- c("YAP1 singles", "BRCA1 RING", "UBE4B MOUSE",
  "BLAT ECOLX 2013", "PABP singles", "GAL4 YEAST", "RL401 2013",
  "RL401 2016", "RL401 2014", "IF1 ECOLI", "BRCA1 BRCT",
  "TIM SULSO", "TIM THETH", "TIM THEMA", "DLG4 RAT",
  "POLG HCVJF", "MTH3 HAEAESTABILIZED", "SUMO1 HUMAN",
  "CALM1 HUMAN", "PA FLU", "UBC9 HUMAN", "RASH HUMAN",
  "TPK1 HUMAN", "BG STRSQ", "TPMT HUMAN", "PTEN HUMAN",
  "HSP82 YEAST", "BLAT ECOLX 2015", "KKA2 KLEPN",
  "BLAT ECOLX 2012", "BLAT ECOLX 2014", "AMIE PSEAE",
  "MK01 HUMAN", "B3VI55 LIPST", "B3VI55 LIPSTSTABLE",
  "parEparD all", "HG FLU", "BF520 env", "BG505 env",
  "PABP doubles")
# "HIS7_YEAST_Kondrashov2017_esm2_150M"
