...
label_ESM1v_650M <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", r_squared_ESM1v_650M)))
...
label_8M <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", r_squared_8M)))
...
label_35M <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", r_squared_35M)))
...
label_150M <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", r_squared_150M)))
...
label_650M <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", r_squared_650M)))
...
label_3B <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", r_squared_3B)))
...
label_15B <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", r_squared_15B)))
...
data_text <- data.frame(
  ...
  x = c(1150, 1200, 1200, 1200, 1200, 1200, 620),
  y = c(.78, .78, .78, .78, .78, .78, .83)
)
...
plot_param <- data_with_size %>%
  ...
  coord_trans(x = 'log10')+
    ...
    #scale_y_continuous(limits = c(-.01, 0.9))+
...
plabel_ESM1v_650M <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", pr_squared_ESM1v_650M)))
...
plabel_8M <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", pr_squared_8M)))
...
plabel_35M <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", pr_squared_35M)))
...
plabel_150M <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", pr_squared_150M)))
...
plabel_650M <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", pr_squared_650M)))
...
plabel_3B <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", pr_squared_3B)))
...
plabel_15B <- bquote(R^2 ~ ": " ~ .(sprintf("%.2f", pr_squared_15B)))
...
prot_data_text <- data.frame(
  ...
  Model = c("ESM1v 650M", "ESM2 8M", "ESM2 35M", "ESM2 150M", "ESM2 650M","ESM2 3B", "ESM2 15B"),
  x = c(130, 180, 180, 180, 180, 180, 110),
  y = c(.78, .78, .78, .78, .78, .78, .78)
)
...
sup9_prot_length <- data_with_size %>%
  filter(Model != 'ESM2 15B') %>%
   ...
   coord_trans(x = 'log10')+
    ...
    #scale_y_continuous(limits = c(-.01, .9))+
